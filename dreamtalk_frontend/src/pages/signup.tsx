  ...
  return (
    <div ref={vantaRef} className="relative min-h-screen flex items-center justify-center p-6 bg-black">
      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-lg shadow-dream-rest p-8">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-[#111111] tracking-tight text-center">Create Account</h1>
          <p className="text-sm text-gray-500 mt-1 text-center">Register to start building and interacting with your digital twins.</p>
        </div>
        ...
        {successMsg && (
          <div className="mb-4 p-3 bg-green-50 text-green-700 text-sm rounded-md shadow-sm">
            {successMsg}
          </div>
        )}
