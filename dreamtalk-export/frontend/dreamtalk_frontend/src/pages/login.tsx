    ...
    <div ref={vantaRef} className="relative min-h-screen flex items-center justify-center p-6 bg-[#0A0B0A]">
      ...
      <div className="relative z-10 w-full max-w-md bg-[#161715] rounded-3xl p-8 md:p-10">
        <div className="mb-6 text-center">
          <h1 className="text-2xl font-extrabold text-[#F5F5F0] font-heading tracking-tight">Sign In</h1>
          <p className="text-sm text-[#9CA39A] mt-1">Access your digital twins and active conversations.</p>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-[#1F211E] text-center">
          <p className="text-xs text-[#9CA39A]">
            ...
            <Link href="/signup" className="text-[#C8F02D] hover:underline font-semibold">
              Create an account
            </Link>
          </p>
        </div>
